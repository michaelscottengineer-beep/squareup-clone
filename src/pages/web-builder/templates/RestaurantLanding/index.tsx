...
import { Clock, MapPin, Phone, Mail, Star, ChefHat, UtensilsCrossed } from 'lucide-react';

// Mock Data
const restaurantInfo = {
  name: "La Cuisine Royale",
  tagline: "Where Tradition Meets Innovation",
  description: "Experience the finest fusion of French and Asian cuisine in an elegant atmosphere. Our award-winning chefs create masterpieces that delight both the eyes and palate.",
...
const featuredDishes = [
  {
    ...
    description: "Creamy Arborio rice infused with black truffle, topped with parmesan and micro herbs",
    price: "$42",
    category: "Signature",
    image: "🍚",
  ...
  },
  {
    ...
    description: "Premium A5 Wagyu beef with roasted garlic butter, seasonal vegetables, and red wine reduction",
    price: "$89",
    category: "Premium",
    image: "🥩",
  ...
  },
  {
    ...
    description: "Fresh Atlantic lobster in a creamy cognac sauce, gratinated to perfection",
    price: "$65",
    category: "Signature",
    image: "🦞",
    chef: "Chef Marie Laurent"
  },
  {
    ...
    description: "Pan-seared Chilean sea bass with sweet miso glaze, bok choy, and jasmine rice",
    price: "$56",
    category: "Fusion",
    image: "🐟",
  ...
  },
  {
    ...
    description: "Puff pastry filled with assorted wild mushrooms, goat cheese, and herb duxelles",
    price: "$38",
    category: "Vegetarian",
    image: "🍄",
    chef: "Chef Marie Laurent"
...
export default function RestaurantLanding() {
  ...
  const categories = ["All", "Signature", "Premium", "Fusion", "Vegetarian", "Dessert"];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-slate-800">{restaurantInfo.name}</span>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Our Signature Dishes</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDishes.map((dish) => (
              <Card key={dish.id} className="hover:shadow-xl transition-shadow duration-300 overflow-hidden group">
                ...
                <CardContent>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="text-sm text-slate-500">{dish.chef}</div>
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 mb-4 leading-relaxed">
                Founded in 2009, La Cuisine Royale has been a beacon of culinary excellence, 
                bringing together the finest ingredients and time-honored cooking techniques 
                with modern innovation.
              </p>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Our team of world-class chefs, led by Chef Marie Laurent, creates unforgettable 
                dining experiences that celebrate the art of fine cuisine. Every dish is a testament 
                to our commitment to quality, creativity, and exceptional service.
              </p>
              <Button className="bg-amber-600 hover:bg-amber-700">
                Learn More About Us
              </Button>
      ...
      <section className="py-16 bg-slate-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-300">We're here to serve you an unforgettable experience</p>
          </div>
