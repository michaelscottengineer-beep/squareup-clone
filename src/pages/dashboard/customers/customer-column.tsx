...
export const customerColumns: ColumnDef<TRestaurantCustomer>[] = [
  {
    accessorKey: "name",
    header: "FullName",
  ...
  {
    accessorKey: "statistics.totalOrder",
    header: "Total Order",
    cell: ({ row }) => {
      return (
        <div className={cn(" font-semibold w-max rounded-md px-2 ", {})}>
          {row.original.statistics.totalOrder}
        </div>
      );
    },
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <ViewOrderSheet customerId={row.original.id}></ViewOrderSheet>
