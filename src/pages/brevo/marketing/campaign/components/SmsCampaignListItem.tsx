...
interface SmsCampaignListItemProps {
  item: TCampaign["basicInfo"];
  id: TCampaign["id"];
}

const SmsCampaignListItem = ({ item, id }: SmsCampaignListItemProps) => {
  ...
  return (
    <Card className="flex flex-row  p-4 items-center gap-8">
      ...
      <div className="actions">
        <Button
          onClick={() => {
            navigate("/brevo/sms-campaign/edit/" + id);
          }}
          className=""
...
export default SmsCampaignListItem;
